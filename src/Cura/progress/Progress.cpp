...
#include "Cura/Application.h" //To get the communication channel to send progress through.
#include "Cura/communication/Communication.h" //To send progress through the communication channel.
...
{
    // temporary do nothing and return. sendProgress(percentage) has some problem that can not run.
    return;
    /* 
