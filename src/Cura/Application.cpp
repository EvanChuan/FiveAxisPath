...
#include "Cura/communication/ArcusCommunication.h" //To connect via Arcus to the front-end.
#include "Cura/communication/CommandLine.h" //To use the command line to slice stuff.
#include "Cura/progress/Progress.h"
#include "Cura/utils/ThreadPool.h"
#include "Cura/utils/string.h" //For stringcasecompare.
...
void Application::run(const size_t argc, char** argv)
{
    ...
    if (stringcasecompare(argv[1], "connect") == 0)
    {
        ...
        {   // new a communication and put the arguments into it.
            slice();
        }
    ...
    startThreadPool(); // Start the thread pool and new a thread_pool object
