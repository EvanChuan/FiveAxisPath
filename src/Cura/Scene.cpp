...
#include "Cura/FffProcessor.h" //To start a slice.
#include "Cura/Scene.h"
#include "Cura/Weaver.h"
#include "Cura/Wireframe2gcode.h"
#include "Cura/communication/Communication.h" //To flush g-code and layer view when we're done.
