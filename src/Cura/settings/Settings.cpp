...
#include "Cura/Application.h" //To get the extruders.
#include "Cura/BeadingStrategy/BeadingStrategyFactory.h"
#include "Cura/ExtruderTrain.h"
#include "Cura/Slice.h"
#include "Cura/settings/EnumSettings.h"
#include "Cura/settings/FlowTempGraph.h"
#include "Cura/settings/Settings.h"
#include "Cura/settings/types/Angle.h"
#include "Cura/settings/types/Duration.h" //For duration and time settings.
#include "Cura/settings/types/LayerIndex.h" //For layer index settings.
#include "Cura/settings/types/Ratio.h" //For ratio settings and percentages.
#include "Cura/settings/types/Temperature.h" //For temperature settings.
#include "Cura/settings/types/Velocity.h" //For velocity settings.
#include "Cura/utils/FMatrix4x3.h"
#include "Cura/utils/string.h" //For Escaped.
...
void Settings::Size()
{
    std::cout << "Show settings map size : " << settings.size() << std::endl;
    return;
}
