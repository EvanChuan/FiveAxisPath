...
bool PlaneCutter::cut(Polyhedron& poly_left, Polyhedron& poly_right, const Plane3& pl) {
...
std::pair<Polyhedron, Polyhedron> PlaneCutter::cut(const Polyhedron& poly, const Plane3& pl) {
	Polyhedron o1;
	Polyhedron o2;
	o1 = poly;
	cut(o1, o2, pl);
