...
#include "Cura/mesh.h"
#include "Cura/utils/Simplify.h" //Simplifying at every step to prevent getting lots of vertices from all the insets.
#include "Cura/slicer.h"
#include "Cura/settings/types/Angle.h" //To process the overhang angle.
