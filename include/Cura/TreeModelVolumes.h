...
#include "Cura/settings/EnumSettings.h" //To store whether X/Y or Z distance gets priority.
#include "Cura/settings/types/LayerIndex.h" //Part of the RadiusLayerPair.
#include "Cura/utils/polygon.h" //For polygon parameters.
