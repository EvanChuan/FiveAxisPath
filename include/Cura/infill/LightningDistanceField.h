...
#include "Cura/utils/polygon.h" //Using outlines to fill and tracking overhang.
#include "Cura/utils/SquareGrid.h" //Tracking for each location the distance to overhang.
