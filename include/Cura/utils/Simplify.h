...
#include "Cura/utils/linearAlg2D.h" //To calculate line deviations and intersecting lines.
#include "Cura/settings/Settings.h" //To load the parameters from a Settings object.
