...
#include "Cura/communication/Communication.h" //The class we're implementing.
...
public:
     ...
     */
    static std::unordered_set<std::string> defaultSearchDirectories();
     ...
     * the file.
     */
    static int loadJSON(const std::string& json_filename, Settings& settings);
     ...
     */
    static int loadJSON(const rapidjson::Document& document, const std::unordered_set<std::string>& search_directories, Settings& settings);
     ...
     */
    static void loadJSONSettings(const rapidjson::Value& element, Settings& settings);
     ...
     */
    static const std::string findDefinitionFile(const std::string& definition_id, const std::unordered_set<std::string>& search_directories);
};
