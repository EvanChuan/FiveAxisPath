...
#include "Cura/utils/AABB3D.h" //To track the used build volume for the Griffin header.
#include "Cura/timeEstimate.h"
#include "Cura/settings/EnumSettings.h"
#include "Cura/settings/Settings.h" //For MAX_EXTRUDERS.
#include "Cura/settings/types/Temperature.h" //Bed temperature.
#include "Cura/settings/types/Velocity.h"
#include "Cura/utils/IntPoint.h"
...
private:
    ...
    coord_t current_angle_a;
    coord_t current_angle_c;   
