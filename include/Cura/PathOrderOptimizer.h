...
#include "Cura/InsetOrderOptimizer.h" // for makeOrderIncludeTransitive
#include "Cura/PathOrderPath.h"
#include "Cura/pathPlanning/CombPath.h" //To calculate the combing distance if we want to use combing.
#include "Cura/pathPlanning/LinePolygonsCrossings.h" //To prevent calculating combing distances if we don't cross the combing borders.
#include "Cura/settings/EnumSettings.h" //To get the seam settings.
#include "Cura/settings/ZSeamConfig.h" //To read the seam configuration.
#include "Cura/utils/linearAlg2D.h" //To find the angle of corners to hide seams.
