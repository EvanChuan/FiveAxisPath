...
#include <limits>
#include <stdint.h>
#include "clipper.hpp" //#include "polyclipping/clipper.hpp"
#include "Cura/utils/Point3.h" //For applying Point3Matrices.
#include "Cura/utils/math.h" // for M_PI. Use relative path to avoid pulling <math.h>
